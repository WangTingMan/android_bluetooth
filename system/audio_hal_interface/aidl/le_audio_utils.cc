...
#ifdef _MSC_VER
      ::aidl::android::hardware::bluetooth::audio::MetadataLtv::VendorSpecific vendor;
      vendor.opaqueValue = std::vector<uint8_t>( stackMetadata.vendor_specific->begin() + 2,
        stackMetadata.vendor_specific->end() );
      vendor.companyId = stackMetadata.vendor_specific->at( 0 ) | (stackMetadata.vendor_specific->at( 1 ) << 8);
