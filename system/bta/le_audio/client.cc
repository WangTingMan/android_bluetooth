...
#ifdef _MSC_VER
    auto condition = group->stream_conf.stream_params.source.stream_config.codec_frames_blocks_per_sdu;
    uint8_t codec_frame_blocks_per_sdu = condition ? condition : 1;
#else
