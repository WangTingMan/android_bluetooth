...
const acl_interface_t& GetAclInterface() {
  ...
  acl_interface.connection.le.on_connected = acl_ble_enhanced_connection_complete_from_shim;
  ...
  acl_interface.link.classic.on_read_remote_supported_features_complete = acl_process_supported_features;
  acl_interface.link.classic.on_read_remote_extended_features_complete = acl_process_extended_features;
  ...
  acl_interface.link.le.on_parameter_update_request = acl_ble_update_request_event_received;
  acl_interface.link.le.on_data_length_change = acl_ble_data_length_change_event;
    acl_interface.link.le.on_read_remote_version_information_complete = btm_read_remote_version_complete;
